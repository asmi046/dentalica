...
$white_data = [
    ...
    [
        ...
        'title' => '',
        'sub_title' => '',
        'content' => "Эффективное  отбеливание возможно только на качественном оборудовании. Количество и длительность процедур индивидуальны, правильно подобрать их может только врач. Медицина должна быть безопасной - доверяйте здоровье профессионалам",
    ],
];
