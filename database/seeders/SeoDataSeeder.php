    ...
    public function run(): void
    {
        $data = [
            [
                ...
                'page_title' => "Семейная стоматологическая клиника «Денталика»",
            ],
            [
                'url' => "doctors",
            ...
            [
                'url' => "before_after",
                'seo_title' => "Результаты работы специалистов нашей клиники",
                'seo_description' => "Оцените результаты работы специалистов нашей клиники",
                'page_title' => "Примеры работ",
            ]
        ];
