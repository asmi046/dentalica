        ...
        $data = [
            [
                ...
                'resul' => json_encode([
                    ...
                    ['title' => 'синий свет исключает риски ожогов'],
            ...
            [
                ...
                'resul' => json_encode([
                    ...
                    ['title' => 'усиление васкуляризации десны, восстановление ее анатомической формы и цвета'],
            ...
            [
                ...
                'resul' => json_encode([
                    ...
                    ['title' => 'идеальное прилегание к зубу, закрытие излишних промежутков между зубами'],
            ...
            [
                ...
                'good_pacients' => "",
                'resul' => json_encode([
                    ['title' => 'профилактика  развития кариеса, пародонтоза, гингивита и других заболеваний полости рта, является обязательным этапом в комплексном лечении патологии десен'],
                    ...
                    ['title' => 'уменьшение болезненности и воспаления тканей десны, в том числе вокруг коронок и протезов, имплантатов без  их  повреждения'],
