    ...
    public function run(): void
    {
        ...
        $data = [
            [
                ...
                'good_pacients' => "",
                'resul' => json_encode([
                    ['title' => 'осветления эмали зубов  на 7-10 тонов'],
                    ['title' => 'хорошо заметный и стойкий  результат, достигаемый чаще всего за 1 процедуру длительностью всего 1,5 часа'],
                    ['title' => 'белизна улыбки сохраниться в течение 2-3 лет (при соблюдении пациентом рекомендации стоматолога и качественном ежедневном  уходе за зубами )'],
                    ['title' => 'возможностью индивидуальной настройки мощности оборудования для зубов с повышенной чувствительностью, щадящее действие на эмаль, синий свет, исключающий риски ожогов'],
                    ['title' => 'эффективность при устранении никотиновой и пищевой пигментации, при осветлении тетрациклиновых зубов и пятен от флюороза'],
                ]),
                'adv' => json_encode([
                    ['title' => 'БЕЗОПАСНО'],
            ...
            [
                ...
                'resul' => json_encode([
                    ...
                    ['title' => 'усиление васкуляризации десен, восстановление ее анатомической формы и цвета.'],
                    ['title' => 'устранение неприятного запаха изо рта'],
                    ['title' => 'улучшение приживаемости и снижение риска отторжения имплантов.'],
                    ['title' => 'ускорение заживления лунки зуба после удаления и т.п.'],
                ]),
                'adv' => json_encode([
                    ['title' => 'БЕЗОПАСНО'],
                    ['title' => 'ЭФФЕКТИВНО'],
            ...
            [
                ...
                'good_pacients' => "",
                'resul' => json_encode([
                    ['title' => 'позволяет предотвратить развитие кариеса, пародонтоза, гингивита и других заболеваний полости рта, является обязательным этапом в комплексном лечении патологии десен'],
                    ['title' => 'уменьшение кровоточивости десен'],
                    ['title' => 'уменьшает или устраняет неприятный запах изо рта'],
