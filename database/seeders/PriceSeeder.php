...
class PriceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [
                'title' => "Услуги по стоматологии ортопедической (Виниры, искусственные коронки)",
                'description' => "Услуги по стоматологии ортопедической (Виниры, искусственные коронки)",
