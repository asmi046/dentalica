    ...
    public function run(): void
    {
        ...
        DB::table("pages")->insert(
            [
                 ...
                 [
                     'title' => 'Права и обязанностях граждан в сфере охраны здоровья, правила внутреннего распорядка для потребителей услуг',
                     'slug' => Str::slug("Права и обязанностях граждан в сфере охраны здоровья, правила внутреннего распорядка для потребителей услуг"),
                     'img' => "pages/main_bnr.webp",
                     'description' => file_get_contents(public_path('old_data//dop_information//prava_gr.html')),
                     'seo_title' => 'Права и обязанностях граждан в сфере охраны здоровья, правила внутреннего распорядка для потребителей услуг',
                     'seo_description' => 'Права и обязанностях граждан в сфере охраны здоровья, правила внутреннего распорядка для потребителей услуг',
                 ],
            ]);
