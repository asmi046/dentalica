...
<head>
    ...
    <meta name="yandex-verification" content="ff3cf70d175ec327" />
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/98994603" style="position:absolute; left:-9999px;" alt="" />
        </div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
</head>
...
<body>
    <div id="all_modal_win">
        ...
        <modal-window rout="/send_consult" redirect="/thencs" hesh="showModal" title="Помощь специалиста"
            subtitle="Оставьте свой телефон и мы свяжемся с Вами."></modal-window>
    </div>
