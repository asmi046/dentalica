            ...
            <div class="information">
                <div class="numbers">
                    ...
                    <div class="elelemt">
                        ...
                        <p class="text_comment">Статей и текстовых материалов по вопросам стоматологии</p>
                        <a href="{{ route('blog.texts') }}" class="button">Читать</a>
                    </div>

                    <div class="elelemt">
                        <div class="number">{{ $videos_count }}</div>
                        <p class="text_comment">Познавательных видео на тему ухода за зубами и подготовки к имплантации
                        </p>
